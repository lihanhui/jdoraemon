...
public interface LeaseLockAsync {
     ...
     */
	LeaseLockFuture<Boolean> forceUnlockAsync();
     ...
     * @return void
     */
	LeaseLockFuture<Void> unlockAsync();
     ...
     * @return void
     */
	LeaseLockFuture<Void> unlockAsync(long threadId);
     ...
     */
	LeaseLockFuture<Boolean> tryLockAsync();
     ...
     * @return void
     */
	LeaseLockFuture<Void> lockAsync();
     ...
     * @return void
     */
	LeaseLockFuture<Void> lockAsync(long threadId);
     ...
     * @return void
     */
	LeaseLockFuture<Void> lockAsync(long leaseTime, TimeUnit unit);
     ...
     * @return void
     */
	LeaseLockFuture<Void> lockAsync(long leaseTime, TimeUnit unit, long threadId);
     ...
     * @return <code>true</code> if lock acquired otherwise <code>false</code>
     */
	LeaseLockFuture<Boolean> tryLockAsync(long threadId);
     ...
     */
	LeaseLockFuture<Boolean> tryLockAsync(long waitTime, TimeUnit unit);
     ...
     *          otherwise <code>false</code> if lock is already set.
     */
	LeaseLockFuture<Boolean> tryLockAsync(long waitTime, long leaseTime, TimeUnit unit);
     ...
     * @return <code>true</code> if lock acquired otherwise <code>false</code>
     */
	LeaseLockFuture<Boolean> tryLockAsync(long waitTime, long leaseTime, TimeUnit unit, long threadId);
     ...
     */
    LeaseLockFuture<Integer> getHoldCountAsync();
     ...
     */
    LeaseLockFuture<Boolean> isLockedAsync();
     ...
     */
    LeaseLockFuture<Long> remainTimeToLiveAsync();
}
